...
c = [nam if (nam.name.startswith('C')) or (nam.name.startswith('D')) else (nam.name.startswith('E')) for nam in humans]
print(c)
...
e = ['-'.join(i.__dict__.keys()) for i in humans]
#e = ['-'.join(i) for i in humans
print(e)
